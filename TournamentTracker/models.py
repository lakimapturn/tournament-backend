...
class Tournament(models.Model):
    ...
    sport = models.ForeignKey(
        Sport, on_delete=models.CASCADE, null=False, blank=False)
    winner = models.ForeignKey(
        School, on_delete=models.CASCADE, null=True, blank=True)
    start_date = models.DateField(null=False, blank=False)
    end_date = models.DateField(null=False, blank=False)
    categories = models.ManyToManyField(
        Category, related_name="category_tournaments", blank=False)
    event_types = models.ManyToManyField(
        EventType, related_name="event_tournaments", blank=False)
    schools = models.ManyToManyField(
        SchoolPoints, related_name="tournaments", blank=True)
...
class Team(models.Model):
    tournament = models.ForeignKey(Tournament, on_delete=models.CASCADE,
                                   null=False, blank=False, default="", related_name="tournament_teams")
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, null=False, blank=False, default="")
    school = models.ForeignKey(
    ...
    team_num = models.PositiveSmallIntegerField(
...
class TempPlayer(models.Model):
    ...
    last_name = models.CharField(
        max_length=100, null=False, blank=False, default="")
    tournament = models.ForeignKey(Tournament, on_delete=models.CASCADE,
                                   null=False, blank=False, default="", related_name="temp_players")
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, null=False, blank=False, default="")
    school = models.ForeignKey(
        School, on_delete=models.CASCADE, null=False, blank=False)
...
class Match(models.Model):
    ...
    tournament = models.ForeignKey(Tournament, on_delete=models.CASCADE,
                                   null=False, blank=False, related_name="tournament_matches")
    category = models.ForeignKey(Category, on_delete=models.CASCADE,
                                 null=False, blank=False, related_name="category_matches")
    team1 = models.ForeignKey(Team, on_delete=models.CASCADE,
                              blank=True, null=True, related_name="team1_match")
    team2 = models.ForeignKey(Team, on_delete=models.CASCADE,
                              blank=True, null=True, related_name="team2_match")
    winner = models.ForeignKey(
        Team, on_delete=models.CASCADE, blank=True, null=True, related_name="match_winner")
    ...
    played_by = models.ManyToManyField(
        Player, blank=True, related_name="matches_played")
